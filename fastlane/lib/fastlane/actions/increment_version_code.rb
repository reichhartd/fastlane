      ...
      def self.available_options
        ...
        [
          FastlaneCore::ConfigItem.new(key: :api_token,
                                       env_name: "FL_INCREMENT_VERSION_CODE_API_TOKEN", # The name of the environment variable
                                       description: "API Token for IncrementVersionCodeAction", # a short description of this parameter
                                       verify_block: proc do |value|
                                          UI.user_error!("No API token for IncrementVersionCodeAction given, pass using `api_token: 'token'`") unless (value and not value.empty?)
